...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-20%] left-[-20%] w-[50%] h-[50%] bg-indigo-900/20 blur-[120px] rounded-full pointer-events-none"></div>
            <div className="absolute bottom-[-20%] right-[-20%] w-[50%] h-[50%] bg-purple-900/20 blur-[120px] rounded-full pointer-events-none"></div>
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-500 italic">Begin your narrative today.</p>
                </div>

                {/* Auth Card */}
                <div className="glass-effect p-8 rounded-xl border border-white/10 shadow-2xl bg-neutral-900/60 backdrop-blur-xl relative overflow-hidden">
